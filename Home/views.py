...
def home(request):
    ...
    params['passagemfsm'] = "Mutual funds are investment vehicles that pool money from multiple investors to create a diversified portfolio of securities such as stocks bonds and other assets One of the main benefits of mutual funds is that they provide individual investors with access to professional management and expertise even with relatively small amounts of money."
